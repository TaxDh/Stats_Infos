...
# transformation inverse générale page 16
...
r_geo_bern <- function(n, p){
  ...
  for(i in 1:n){
    ...
    j <- 1
    y <- runif(1) <= p #generation une bernouilli
    while(y == 0){
...
# exercice: écrire une fonction r_poisson_exp afin générer un échantillon ech de taille n=1000 selon la loi de Poisson par la méthode vue en classe,
# et utiliser le code suivant pour tester votre méthode
